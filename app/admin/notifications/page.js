                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: item.read ? "var(--surface)" : "rgba(239, 68, 68, 0.03)",
                      padding: "18px",
                      gap: "12px",
                      borderRadius: "8px"
                    }}
                  >
                    ...
                    <div className="row between" style={{ alignItems: "flex-start" }}>
                      <div>
                        ...
                        >
                          🔴 ACTION REQUIRED &bull; 🏠 HOME DELIVERY REQUEST
                        </span>
                    ...
                    <div style={{ fontSize: "0.9rem" }}>
                      ...
                      <div className="row" style={{ gap: "16px" }}>
                        <span>
                          Books Subtotal: <strong>{formatINR(meta.subtotalAmount || 0)}</strong>
                        </span>
                        <span>
                          Delivery Charge: <strong style={{ color: "#d97706" }}>TO BE CONFIRMED</strong>
                        </span>
                      </div>
                    </div>
